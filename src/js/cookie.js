...
if (tempWords != "" && tempWords != '[]' && setIsStillValid) {
  ...
  Array.from(document.getElementById('set').children).forEach(e => e.children[0].checked = false);
  if (document.getElementById('untema')) {
    document.getElementById('untema').checked = true;
  }
  if (document.getElementById('unaidea')) {
    document.getElementById('unaidea').checked = true;
  }
  if (document.getElementById('elaborar')) {
    document.getElementById('elaborar').checked = true;
  }
  selectSet();

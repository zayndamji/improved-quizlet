...
if (tempWords != "" && tempWords != '[]' && setIsStillValid) {
  ...
  Array.from(document.getElementById('set').children).forEach(e => e.children[0].checked = false);
  document.getElementById('subjunctive-setchooser').children[0].children[0].checked = true;
  document.getElementById('subjunctive-setchooser').children[1].children[0].checked = true;
  document.getElementById('subjunctive-setchooser').children[2].children[0].checked = true;
  selectSet();

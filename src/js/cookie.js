...
if (tempWords != "" && tempWords != '[]' && setIsStillValid) {
  ...
  Array.from(document.getElementById('set').children).forEach(e => e.children[0].checked = false);
  if (document.getElementById('quiz8gen')) {
    document.getElementById('quiz8gen').checked = true;
  }
  if (document.getElementById('quiz8ref')) {
    document.getElementById('quiz8ref').checked = true;
  }
  selectSet();

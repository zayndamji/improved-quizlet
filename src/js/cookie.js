...
if (tempWords != "" && tempWords != '[]' && setIsStillValid) {
  ...
  Array.from(document.getElementById('set').children).forEach(e => e.children[0].checked = false);
  document.getElementById('finalone-setchooser').children[0].children[0].checked = true;
  document.getElementById('finalone-setchooser').children[1].children[0].checked = true;
  selectSet();

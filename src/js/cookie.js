...
if (tempWords != "" && tempWords != '[]' && setIsStillValid) {
  ...
  Array.from(document.getElementById('set').children).forEach(e => e.children[0].checked = false);
  document.getElementById('vocabulary2-setchooser').children[0].children[0].checked = true;
  document.getElementById('vocabulary2-setchooser').children[1].children[0].checked = true;
  document.getElementById('vocabulary2-setchooser').children[2].children[0].checked = true;
  document.getElementById('vocabulary2-setchooser').children[3].children[0].checked = true;
  document.getElementById('vocabulary2-setchooser').children[4].children[0].checked = true;
  selectSet();
